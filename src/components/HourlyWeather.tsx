...
export default function HourlyWeather({
  ...
  return (
    <>
      ...
      <div className="flex border border-black overflow-x-auto whitespace-nowrap mt-2 mx-20 p-3 xl:p-6 w-11/12 rounded">
        {todayWeather.hour
          .slice(currentHourIndex)
          .map((hourData: HourData, index: number) => (
            <div
              key={index}
              className="border-2 border-gray-300 mx-2 xl:mx-3 py-4 px-6 rounded flex flex-col items-center bg-white text-sm    "
            >
