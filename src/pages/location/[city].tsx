...
export default function Page({ todayWeather, locationData }: Props) {
  ...
  return (
    <div className="xl:p-8">
      <div className="flex flex-col items-center bg-gray-100 min-h-screen rounded-xl p-2">
        <SearchBar />
        <div className=" border border-black rounded-xl w-11/12 xl:w-9/12 p-4 flex justify-between xl:px-16 xl:py-8 bg-white mt-10 xl:mt-20">
          <div>
